...
class OCRModelExecutor(context: Context, private var useGPU: Boolean = false) : AutoCloseable {
  ...
  companion object {
    ...
    private const val textRecognitionModel = "lite-model_keras-ocr_float16_2.tflite"
    private const val numberThreads = 4
    private const val alphabets = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPRQSTUVWXYZ"
